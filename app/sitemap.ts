...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/members`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/join`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.8 },
